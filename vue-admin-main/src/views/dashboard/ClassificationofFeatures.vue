...
methods: {
    /******************上传文件方法******************/
      async uploadFiles(info) {
        ...
        //开始真正上传
        //上传接口
        let uploadApiUrl = "https://localhost:3100/basic-api/upload_classification_features_img/";
        //调用公共上传方法
        this.loading = true;
      ...
      uploadFilesToServer(uploadApiUrl, fileName, files) {
        ...
        formData.append('ClassificationofFeatures', files);
